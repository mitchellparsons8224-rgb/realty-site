...
const inputClass =
  "w-full bg-transparent border-b border-white/30 py-3 text-base sm:text-sm font-sans text-white placeholder:text-white/40 focus:outline-none focus:border-white transition-colors duration-300 uppercase tracking-widest";
    ...
    <form action={action} className="space-y-8">
      ...
      <div className="flex items-start gap-3">
        ...
        <label htmlFor="consent" className="text-xs font-sans text-white/40 leading-relaxed cursor-pointer">
          ...
          <a href="/privacy" className="underline hover:text-white/70 transition-colors duration-200">Privacy Policy</a>.
        </label>
      </div>
